...
class StartWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.title.setText("Викторина на знание столиц мира")
        self.font = QtGui.QFont()
        ...
        self.question_text.setGeometry(250, 50, 200, 200)
        # self.question_text.setText("Столица Бразилии?")
        self.question_text.setWordWrap(True)
        self.question_text.hide()
        # self.question_text.adjustSize()

        # self.password_text.setFont(self.font)
        # self.password_text.setAlignment(QtCore.Qt.AlignCenter)
        self.line = QtWidgets.QLineEdit(self)
        self.line.setFocus()

        # self.line_login.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
    ...
    def show_questions(self):
        ...
        if self.index < len(self.questions):
            ...
            if self.index < len(self.questions):
                ...
                self.question_text.hide()
                # self.result = QtWidgets.QLabel(self)
                # self.result.setGeometry(200, 50, 200, 200)
